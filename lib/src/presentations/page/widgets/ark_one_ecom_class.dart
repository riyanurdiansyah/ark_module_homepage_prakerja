...
class ArkOneEcomClass extends StatelessWidget {
  const ArkOneEcomClass({
    Key? key,
        ...
        itemBuilder: (context, index) {
          ...
          return InkWell(
            onTap: () => Get.toNamed('/class-prakerja',
                arguments: _prakerjaHC.listHomeEcome[index].id),
            child: SizedBox(
              width: 270,
              child: Card(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: NetworkImage(
                              _prakerjaHC.listHomeEcome[index].image!,
                            ),
                            fit: BoxFit.fitWidth),
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            _prakerjaHC.listHomeEcome[index].title!,
                            style: const TextStyle(
                              fontSize: 12,
